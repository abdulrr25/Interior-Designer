      ...
      <div className="container">
        <div className="pt-4">
          ...
          >
            ...
            offices, apartments, and more. With a highly experienced team, we
            ensure quality and excellence in all our projects.
          </motion.p>
        </div>
        ...
        <div className="items-center lg:flex gap-x-8 lg:px-10">
          ...
          <motion.div
            ...
            variants={tagVariants}
          >
            <p className="pb-8 tracking-tight mt-6 text-justify p-2">
              We are a team of internationally acclaimed architects committed to
              redefining architectural education and innovation. At the heart of
              our work is a dedication to integrating new societal visions and
              enhancing communication in design. Our handcrafted designs
              showcase creativity, precision, and functionality. <br /> <br />
              Through our services, we strive to deliver exceptional quality
              that stands the test of time. From crafting architectural
              portfolios to designing homes, we emphasize innovation and
        ...
        <div className="lg:py-20 lg:px-20">
          ...
          <div className="grid py-8 gap-20 lg:grid-cols-3 sm:p-2">
            <motion.div
              initial="offscreen"
              whileInView={"onscreen"}
              variants={titleVariants}
            ...
            >
              <div className="p-4 text-center bg-gray-100 aspect-square dark:bg-[#292C3D] -m-0.5 transition hover:-translate-y-3 hover:-translate-x-3">
                <Image
                  ...
                  width={200}
                  height={200}
                  alt="Javed Ahmad - Director"
                  className="mx-auto rounded-full w-52 h-52"
                />
                <h2 className="py-2 text-2xl font-semibold uppercase">
                  Javed Ahmad
                </h2>
                <h3 className="font-semibold">Director</h3>
                <p className="text-sm">
                  leading the team with 4+ years of experience, ensuring
                  innovative and high-quality designs for every project.
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="p-4 text-center bg-gray-100 aspect-square dark:bg-[#292C3D] -m-0.5 transition hover:-translate-y-3 hover:-translate-x-3">
                <Image
                  ...
                  width={200}
                  height={200}
                  alt="Tashreeq Ahmad - Marketing Manager"
                  className="mx-auto rounded-full w-52 h-52"
                />
                <h2 className="py-2 text-2xl font-semibold uppercase">
                  Tashreeq Ahmad
                ...
                <p className="text-sm">
                  Tashreeq manages our marketing efforts, driving brand growth
                  and ensuring our services reach the right audience.
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="p-4 text-center bg-gray-100 aspect-square dark:bg-[#292C3D] -m-0.5 transition hover:-translate-y-3 hover:-translate-x-3">
                ...
                <p className="text-sm">
                  Saleem oversees sales strategy, building client relationships,
